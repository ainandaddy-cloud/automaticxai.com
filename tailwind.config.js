  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-button': 'linear-gradient(145deg, #34B27B, #4ec99a)',
        'gradient-button-hover': 'linear-gradient(145deg, #4ec99a, #34B27B)',
      ...
      boxShadow: {
        'glow-yellow': '0 0 20px rgba(52, 178, 123, 0.4)',
        'glow-yellow-strong': '0 0 30px rgba(52, 178, 123, 0.6)',
        'glass': '0 8px 32px rgba(0, 0, 0, 0.3)',
        'glass-light': '0 8px 32px rgba(0, 0, 0, 0.1)',
        'card': '0 4px 16px rgba(0, 0, 0, 0.2)',
        'card-hover': '0 8px 32px rgba(52, 178, 123, 0.2)',
        'card-light': '0 4px 16px rgba(0, 0, 0, 0.1)',
        'card-hover-light': '0 8px 32px rgba(52, 178, 123, 0.15)',
      },
      backdropBlur: {
        'glass': '16px',
      },
      keyframes: {
        ...
        'glow': {
          '0%, 100%': { boxShadow: '0 0 20px rgba(52, 178, 123, 0.3)' },
          '50%': { boxShadow: '0 0 30px rgba(52, 178, 123, 0.5)' },
        },
        'float': {
        ...
        'pulse-glow': {
          '0%, 100%': {
            boxShadow: '0 0 20px rgba(52, 178, 123, 0.4)',
            transform: 'scale(1)'
          },
          '50%': {
            boxShadow: '0 0 40px rgba(52, 178, 123, 0.8)',
